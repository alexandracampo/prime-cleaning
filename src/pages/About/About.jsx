...
const About = () => {
    ...
    return (
        <section
            id="about"
            className="h-[calc(100vh)] bg-gray-200 flex flex-col justify-center items-center pl-8 pr-8 pb-0 pt-20 md:pt-10 lg:pt-10"
            style={isMobile ? {
                backgroundImage: `url('nosotrosBG.png')`,
                backgroundSize: 'cover',
            } : {}}
        >
            <h2 className="text-sm lg:text-4xl md:text-2xl font-bold text-gray-800 mb-4  md:pb-10 lg:pb-10">Sobre Nosotros</h2>
            <p className="text-sm lg:text-xl md:text-m text-gray-800 max-w-3xl mb-6 lg:mx-6 md:mx-24">
            ...
            <p className="text-sm lg:text-xl md:text-m text-gray-800 max-w-3xl lg:mx-6 md:mx-24 mb-0">
